...
public class AdaptadorRecycleView extends RecyclerView.Adapter<AdaptadorRecycleView.MyViewHolder>{
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View itemView) {
            super(itemView);
            this.textViewNombre = (TextView) itemView.findViewById(R.id.textViewNombre);
            this.textViewDestino = (TextView) itemView.findViewById(R.id.textViewDestino);
            this.imageViewIcon = (ImageView) itemView.findViewById(R.id.imageView);
        }
    ...
    public AdaptadorRecycleView(ArrayList<Paquete> paquetes, Resources resource) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int listPosition) {
        ...
        TextView textViewNombre = holder.textViewNombre;
        TextView textViewDestino = holder.textViewDestino;
        ImageView imageView = holder.imageViewIcon;

        textViewNombre.setText(paquetes.get(listPosition).getNombre());
        textViewDestino.setText(paquetes.get(listPosition).getDestino());
        //imageView.setImageResource(cardDataSet.get(listPosition).getImage());

        File imgFile = new  File(paquetes.get(listPosition).getImagen());
        ...
        //imageView.setImageBitmap(decodeSampledBitmapFromResource(resource, paquetes.get(listPosition).getImage(), 200, 150));
    }
 */
